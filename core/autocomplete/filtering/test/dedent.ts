/**
 * Template tag that strips the common leading indentation from a block, so test
 * fixtures can be written at their natural indentation level.
 *
 * Lifted out of upstream Continue's `core/util/index.ts` when the rest of that
 * file (all chat/markdown helpers) became unreachable.
 */
